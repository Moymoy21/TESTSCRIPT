...
createCustomButton("Section 4", "Load Valve and Terminals", "Teleports through all valves and terminals sequentially", function()
    local Players = game:GetService("Players")
    local StarterGui = game:GetService("StarterGui")
    ...
    notify("Sequence Started", "Teleporting through valves and terminals...", 2)
    ...
    for i, loc in ipairs(locations) do
        ...
        notify("Progress", "Teleported to " .. loc.name .. " (" .. i .. "/" .. #locations .. ")", 1)
        task.wait(0.5) -- 0.5 seconds delay bago lumipat sa sunod
    end

    notify("Complete", "All valves and terminals loaded!", 3)
end)
