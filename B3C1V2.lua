...
createCustomButton("Section 4", "Load Valve and Terminals", "Tween through all valves and terminals sequentially", function()
    local Players = game:GetService("Players")
    local StarterGui = game:GetService("StarterGui")
    local TweenService = game:GetService("TweenService")
    ...
    -- Fast tween function (Speed 250 studs per second)
    local function fastTweenTo(targetCFrame)
        ...
        task.wait(0.2) -- Kaunting hintay para mag-load ang assets sa pwesto
    end

    local locations = {
        {name = "Valve 1", cframe = CFrame.new(-3494.72998, -299.027924, 4450.64551, -8.10623169e-05, 1, -8.10623169e-05, -8.10623169e-05, 8.10623169e-05, 1, 1, 8.10623169e-05, 8.10623169e-05)},
        {name = "Valve 2", cframe = CFrame.new(-3301.02466, -298.876373, 4297.02393, 0, 1, 0, 0, 0, -1, -1, 0, 0)},
        {name = "Valve 3", cframe = CFrame.new(-3403.68823, -296.572876, 4435.92871, -8.10623169e-05, -1, -8.10623169e-05, 8.10623169e-05, 8.10623169e-05, -1, 1, -8.10623169e-05, 8.10623169e-05)},
        {name = "Valve 4", cframe = CFrame.new(-3478.40918, -297.507202, 4446.16699, -1.00000024, 0, 0, 0, -1.1920929e-07, 1.00000012, 0, 1.00000012, -1.1920929e-07)},
        {name = "Valve 5", cframe = CFrame.new(-3356.0752, -297.903046, 4221.91211, 1, 0, 0, 0, -1.1920929e-07, 1.00000012, 0, -1.00000012, -1.1920929e-07)},
        {name = "Terminal 1", cframe = CFrame.new(-3308.0813, -300.804779, 4364.27441, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07)},
        {name = "Terminal 2", cframe = CFrame.new(-3348.9126, -300.804779, 4360.38184, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07)},
        {name = "Terminal 3", cframe = CFrame.new(-3338.27686, -300.829041, 4262.69043, -1, 0, 0, 0, 1, 0, 0, 0, -1)},
        {name = "Terminal 4", cframe = CFrame.new(-3367.49683, -300.804779, 4416.18604, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07)}
    }

    notify("Tween Sequence Started", "Tweening through valves and terminals...", 2)

    for i, loc in ipairs(locations) do
        notify("Progress", "Tweening to " .. loc.name .. " (" .. i .. "/" .. #locations .. ")", 1)
        fastTweenTo(loc.cframe)
    end

    notify("Complete", "All valves and terminals successfully loaded via tween!", 3)
end)
