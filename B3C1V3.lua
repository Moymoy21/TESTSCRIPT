...
createCustomButton("Section 4", "Activate Computer", "Teleports to Computer and activates it", function()
    local Players = game:GetService("Players")
    local Workspace = game:GetService("Workspace")
    local StarterGui = game:GetService("StarterGui")
    ...
    notify("Computer", "Teleporting to Computer...", 1.5)
    ...
    if compPrompt then
        ...
        notify("Success", "Computer activated!", 2)
    else
        notify("Warning", "Computer prompt not found!", 2)
    end
end)
